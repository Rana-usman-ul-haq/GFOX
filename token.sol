...
contract GenerousFox is ERC20, Ownable {

    mapping (address => bool) public isBlackListed;
    bool public _isTradeOpen = true;


    constructor() ERC20("GenerousFox", "GFOX") {
    ...
    function _transfer(
        ...
        require(isBlackListed[sender] != true && isBlackListed[recipient] != true, "Account is Blacklisted");
